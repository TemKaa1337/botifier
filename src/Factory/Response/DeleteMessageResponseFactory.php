...
use Temkaa\Botifier\Model\Response\DeleteMessageResponse;
use Temkaa\Botifier\Model\ResponseInterface;

final readonly class DeleteMessageResponseFactory implements FactoryInterface
{
    ...
    {
        return $method === ApiMethod::DeleteMessage;
    }
}
