...
use Temkaa\Botifier\Model\Response\PromoteChatMemberResponse;
use Temkaa\Botifier\Model\ResponseInterface;

final readonly class PromoteChatMemberResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new PromoteChatMemberResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::PromoteChatMember;
    }
}
