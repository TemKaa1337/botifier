...
final readonly class CreateChatSubscriptionInviteLinkResponseFactory implements FactoryInterface
{
    ...
    {
        return new CreateChatSubscriptionInviteLinkResponse(
            $message['ok'],
    ...
    {
        return $method === ApiMethod::CreateChatSubscriptionInviteLink;
    }
}
