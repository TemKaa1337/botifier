...
final readonly class StopMessageLiveLocationResponseFactory implements FactoryInterface
{
    ...
    {
        return new StopMessageLiveLocationResponse(
            $message['ok'],
            match (true) {
    ...
    {
        return $method === ApiMethod::StopMessageLiveLocation;
    }
}
