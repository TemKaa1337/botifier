...
final readonly class SetMyDefaultAdministratorRightsResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new SetMyDefaultAdministratorRightsResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::SetMyDefaultAdministratorRights;
    }
}
