...
use Temkaa\Botifier\Model\Response\SendLocationResponse;

final readonly class SendLocationResponseFactory implements FactoryInterface
{
    ...
    {
        return $method === ApiMethod::SendLocation;
    }
}
