...
final readonly class UnpinAllForumTopicMessagesResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new UnpinAllForumTopicMessagesResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::UnpinAllForumTopicMessages;
    }
}
