...
use Temkaa\Botifier\Model\Response\CreateInvoiceLinkResponse;
use Temkaa\Botifier\Model\ResponseInterface;

final readonly class CreateInvoiceLinkResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new CreateInvoiceLinkResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::CreateInvoiceLink;
    }
}
