...
final readonly class EditMessageLiveLocationResponseFactory implements FactoryInterface
{
    ...
    {
        return new EditMessageLiveLocationResponse(
            $message['ok'],
            match (true) {
    ...
    {
        return $method === ApiMethod::EditMessageLiveLocation;
    }
}
