...
final readonly class SetCustomEmojiStickerSetThumbnailResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new SetCustomEmojiStickerSetThumbnailResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::SetCustomEmojiStickerSetThumbnail;
    }
}
