...
use Temkaa\Botifier\Model\Response\ExportChatInviteLinkResponse;

final readonly class ExportChatInviteLinkResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new ExportChatInviteLinkResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::ExportChatInviteLink;
    }
}
