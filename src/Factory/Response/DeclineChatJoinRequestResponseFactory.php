...
use Temkaa\Botifier\Model\Response\DeclineChatJoinRequestResponse;
use Temkaa\Botifier\Model\ResponseInterface;

final readonly class DeclineChatJoinRequestResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new DeclineChatJoinRequestResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::DeclineChatJoinRequest;
    }
}
