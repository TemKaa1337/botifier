...
final readonly class UnpinAllGeneralForumTopicMessagesResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new UnpinAllGeneralForumTopicMessagesResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::UnpinAllGeneralForumTopicMessages;
    }
}
