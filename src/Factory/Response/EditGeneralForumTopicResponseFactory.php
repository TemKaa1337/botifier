...
use Temkaa\Botifier\Model\Response\EditGeneralForumTopicResponse;
use Temkaa\Botifier\Model\ResponseInterface;

final readonly class EditGeneralForumTopicResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new EditGeneralForumTopicResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::EditGeneralForumTopic;
    }
}
