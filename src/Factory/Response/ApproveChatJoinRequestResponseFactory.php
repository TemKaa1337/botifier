...
final readonly class ApproveChatJoinRequestResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new ApproveChatJoinRequestResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::ApproveChatJoinRequest;
    }
}
