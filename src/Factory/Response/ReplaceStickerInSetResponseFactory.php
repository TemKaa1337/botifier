...
final readonly class ReplaceStickerInSetResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new ReplaceStickerInSetResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::ReplaceStickerInSet;
    }
}
