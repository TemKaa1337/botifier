...
use Temkaa\Botifier\Model\Response\HideGeneralForumTopicResponse;

final readonly class HideGeneralForumTopicResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new HideGeneralForumTopicResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::HideGeneralForumTopic;
    }
}
