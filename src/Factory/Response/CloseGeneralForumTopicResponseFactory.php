...
use Temkaa\Botifier\Model\Response\CloseGeneralForumTopicResponse;

final readonly class CloseGeneralForumTopicResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new CloseGeneralForumTopicResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::CloseGeneralForumTopic;
    }
}
