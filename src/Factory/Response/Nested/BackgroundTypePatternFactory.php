...
use Temkaa\Botifier\Model\Response\Nested\BackgroundTypePattern;
...
final readonly class BackgroundTypePatternFactory
{
    ...
    public function create(array $message): BackgroundTypePattern
    {
        return new BackgroundTypePattern(
            ...
            match (true) {
                $message['fill']['type'] === 'solid'             => $this->backgroundFillSolidFactory->create($message['fill']),
                $message['fill']['type'] === 'gradient'          => $this->backgroundFillGradientFactory->create($message['fill']),
                $message['fill']['type'] === 'freeform_gradient' => $this->backgroundFillFreeformGradientFactory->create($message['fill']),
