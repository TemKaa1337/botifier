...
use Temkaa\Botifier\Model\Response\Nested\ChatBackground;
    ...
    public function create(array $message): ChatBackground
    {
        return new ChatBackground(
            match (true) {
                ...
                $message['type']['type'] === 'wallpaper'  => $this->backgroundTypeWallpaperFactory->create($message['type']),
                $message['type']['type'] === 'pattern'    => $this->backgroundTypePatternFactory->create($message['type']),
                $message['type']['type'] === 'chat_theme' => $this->backgroundTypeChatThemeFactory->create($message['type']),
