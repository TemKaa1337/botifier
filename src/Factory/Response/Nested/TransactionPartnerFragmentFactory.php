...
use Temkaa\Botifier\Model\Response\Nested\TransactionPartnerFragment;
    ...
    public function create(array $message): TransactionPartnerFragment
    {
        return new TransactionPartnerFragment(
            ...
            match (true) {
                ...
                $message['withdrawal_state']['type'] === 'pending'   => $this->revenueWithdrawalStatePendingFactory->create($message['withdrawal_state']),
                $message['withdrawal_state']['type'] === 'succeeded' => $this->revenueWithdrawalStateSucceededFactory->create($message['withdrawal_state']),
                $message['withdrawal_state']['type'] === 'failed'    => $this->revenueWithdrawalStateFailedFactory->create($message['withdrawal_state']),
