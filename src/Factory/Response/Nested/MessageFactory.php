...
use Temkaa\Botifier\Factory\Shared\InlineKeyboardMarkupFactory;
use Temkaa\Botifier\Factory\Shared\LinkPreviewOptionsFactory;
    ...
    public function create(array $message): Message
    {
        return new Message(
            ...
            match (true) {
                ...
                $message['forward_origin']['type'] === 'user'        => $this->messageOriginUserFactory->create($message['forward_origin']),
                $message['forward_origin']['type'] === 'hidden_user' => $this->messageOriginHiddenUserFactory->create($message['forward_origin']),
                $message['forward_origin']['type'] === 'chat'        => $this->messageOriginChatFactory->create($message['forward_origin']),
                $message['forward_origin']['type'] === 'channel'     => $this->messageOriginChannelFactory->create($message['forward_origin']),
            ...
            isset($message['external_reply']) ? $this->externalReplyInfoFactory->create($message['external_reply']) : null,
            ...
            isset($message['edit_date']) ? (new DateTimeImmutable())->setTimestamp($message['edit_date'])->setTimezone(new DateTimeZone('UTC')) : null,
            ...
            isset($message['link_preview_options']) ? $this->linkPreviewOptionsFactory->create($message['link_preview_options']) : null,
            ...
            isset($message['message_auto_delete_timer_changed']) ? $this->messageAutoDeleteTimerChangedFactory->create($message['message_auto_delete_timer_changed']) : null,
            ...
            match (true) {
                ...
                default                                      => $this->inaccessibleMessageFactory->create($message['pinned_message'])
            },
            isset($message['invoice']) ? $this->invoiceFactory->create($message['invoice']) : null,
            isset($message['successful_payment']) ? $this->successfulPaymentFactory->create($message['successful_payment']) : null,
            isset($message['refunded_payment']) ? $this->refundedPaymentFactory->create($message['refunded_payment']) : null,
            ...
            isset($message['write_access_allowed']) ? $this->writeAccessAllowedFactory->create($message['write_access_allowed']) : null,
            isset($message['passport_data']) ? $this->passportDataFactory->create($message['passport_data']) : null,
            isset($message['proximity_alert_triggered']) ? $this->proximityAlertTriggeredFactory->create($message['proximity_alert_triggered']) : null,
            isset($message['boost_added']) ? $this->chatBoostAddedFactory->create($message['boost_added']) : null,
            isset($message['chat_background_set']) ? $this->chatBackgroundFactory->create($message['chat_background_set']) : null,
            isset($message['forum_topic_created']) ? $this->forumTopicCreatedFactory->create($message['forum_topic_created']) : null,
            isset($message['forum_topic_edited']) ? $this->forumTopicEditedFactory->create($message['forum_topic_edited']) : null,
            isset($message['forum_topic_closed']) ? $this->forumTopicClosedFactory->create($message['forum_topic_closed']) : null,
            isset($message['forum_topic_reopened']) ? $this->forumTopicReopenedFactory->create($message['forum_topic_reopened']) : null,
            isset($message['general_forum_topic_hidden']) ? $this->generalForumTopicHiddenFactory->create($message['general_forum_topic_hidden']) : null,
            isset($message['general_forum_topic_unhidden']) ? $this->generalForumTopicUnhiddenFactory->create($message['general_forum_topic_unhidden']) : null,
            isset($message['giveaway_created']) ? $this->giveawayCreatedFactory->create($message['giveaway_created']) : null,
            isset($message['giveaway']) ? $this->giveawayFactory->create($message['giveaway']) : null,
            isset($message['giveaway_winners']) ? $this->giveawayWinnersFactory->create($message['giveaway_winners']) : null,
            isset($message['giveaway_completed']) ? $this->giveawayCompletedFactory->create($message['giveaway_completed']) : null,
            isset($message['video_chat_scheduled']) ? $this->videoChatScheduledFactory->create($message['video_chat_scheduled']) : null,
            isset($message['video_chat_started']) ? $this->videoChatStartedFactory->create($message['video_chat_started']) : null,
            isset($message['video_chat_ended']) ? $this->videoChatEndedFactory->create($message['video_chat_ended']) : null,
            isset($message['video_chat_participants_invited']) ? $this->videoChatParticipantsInvitedFactory->create($message['video_chat_participants_invited']) : null,
            isset($message['web_app_data']) ? $this->webAppDataFactory->create($message['web_app_data']) : null,
            isset($message['reply_markup']) ? $this->inlineKeyboardMarkupFactory->create($message['reply_markup']) : null
        );
    }
