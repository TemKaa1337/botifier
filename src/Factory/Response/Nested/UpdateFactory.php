...
final readonly class UpdateFactory
{
    ...
    public function create(array $message): Update
    {
        return new Update(
            ...
            isset($message['edited_channel_post']) ? $this->messageFactory->create($message['edited_channel_post']) : null,
            isset($message['business_connection']) ? $this->businessConnectionFactory->create($message['business_connection']) : null,
            isset($message['business_message']) ? $this->messageFactory->create($message['business_message']) : null,
            isset($message['edited_business_message']) ? $this->messageFactory->create($message['edited_business_message']) : null,
            isset($message['deleted_business_messages']) ? $this->businessMessagesDeletedFactory->create($message['deleted_business_messages']) : null,
            isset($message['message_reaction']) ? $this->messageReactionUpdatedFactory->create($message['message_reaction']) : null,
            isset($message['message_reaction_count']) ? $this->messageReactionCountUpdatedFactory->create($message['message_reaction_count']) : null,
            isset($message['inline_query']) ? $this->inlineQueryFactory->create($message['inline_query']) : null,
            isset($message['chosen_inline_result']) ? $this->chosenInlineResultFactory->create($message['chosen_inline_result']) : null,
            ...
            isset($message['pre_checkout_query']) ? $this->preCheckoutQueryFactory->create($message['pre_checkout_query']) : null,
            isset($message['purchased_paid_media']) ? $this->paidMediaPurchasedFactory->create($message['purchased_paid_media']) : null,
            ...
            isset($message['my_chat_member']) ? $this->chatMemberUpdatedFactory->create($message['my_chat_member']) : null,
            isset($message['chat_member']) ? $this->chatMemberUpdatedFactory->create($message['chat_member']) : null,
            isset($message['chat_join_request']) ? $this->chatJoinRequestFactory->create($message['chat_join_request']) : null,
            isset($message['chat_boost']) ? $this->chatBoostUpdatedFactory->create($message['chat_boost']) : null,
            isset($message['removed_chat_boost']) ? $this->chatBoostRemovedFactory->create($message['removed_chat_boost']) : null
        );
    }
}
