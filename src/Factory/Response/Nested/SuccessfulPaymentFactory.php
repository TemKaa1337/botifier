...
use DateTimeZone;
use Temkaa\Botifier\Model\Response\Nested\SuccessfulPayment;
...
final readonly class SuccessfulPaymentFactory
{
    ...
    public function create(array $message): SuccessfulPayment
    {
        return new SuccessfulPayment(
            ...
            isset($message['subscription_expiration_date']) ? (new DateTimeImmutable())->setTimestamp($message['subscription_expiration_date'])->setTimezone(new DateTimeZone('UTC')) : null,
