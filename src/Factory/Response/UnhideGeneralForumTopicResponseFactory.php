...
final readonly class UnhideGeneralForumTopicResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new UnhideGeneralForumTopicResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::UnhideGeneralForumTopic;
    }
}
