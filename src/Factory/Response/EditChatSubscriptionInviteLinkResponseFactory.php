...
final readonly class EditChatSubscriptionInviteLinkResponseFactory implements FactoryInterface
{
    ...
    {
        return new EditChatSubscriptionInviteLinkResponse(
            $message['ok'],
    ...
    {
        return $method === ApiMethod::EditChatSubscriptionInviteLink;
    }
}
