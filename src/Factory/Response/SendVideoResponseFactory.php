...
use Temkaa\Botifier\Model\Response\SendVideoResponse;

final readonly class SendVideoResponseFactory implements FactoryInterface
{
    ...
    {
        return $method === ApiMethod::SendVideo;
    }
}
