...
final readonly class RevokeChatInviteLinkResponseFactory implements FactoryInterface
{
    ...
    {
        return new RevokeChatInviteLinkResponse(
            $message['ok'],
    ...
    {
        return $method === ApiMethod::RevokeChatInviteLink;
    }
}
