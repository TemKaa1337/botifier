...
final readonly class CopyMessageResponseFactory implements FactoryInterface
{
    ...
    {
        return new CopyMessageResponse(
            $message['ok'],
            isset($message['result']) ? $this->messageIdFactory->create($message['result']) : null,
    ...
    {
        return $method === ApiMethod::CopyMessage;
    }
}
