...
final readonly class SetChatAdministratorCustomTitleResponseFactory implements FactoryInterface
{
    public function __construct(private ResponseParametersFactory $responseParametersFactory) {}

    public function create(array $message): ResponseInterface
    {
        return new SetChatAdministratorCustomTitleResponse(
            $message['ok'],
            $message['result'] ?? null,
    ...
    {
        return $method === ApiMethod::SetChatAdministratorCustomTitle;
    }
}
