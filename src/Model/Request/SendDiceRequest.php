...
use Temkaa\Botifier\Model\Response\SendDiceResponse;
 ...
 * @api
 *
 * @implements RequestInterface<SendDiceResponse>
 */
final readonly class SendDiceRequest implements RequestInterface
{
