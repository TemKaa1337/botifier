...
abstract class LegacyAbstractRunnerTestCase extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$container = ContainerBuilder::make()->add(new ConfigProvider())->build();
    }
     ...
     */
    protected function getRunner(string $runner, ?ContainerInterface $container = null): RunnerInterface
    {
        return ($container ?? self::$container)->get($runner);
    }
